    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.grid}>
          <Link href="/admin/reviews" className={`${styles.card} ${styles.reviewsCard}`}>
          ...
          <Link href="/admin/comments" className={`${styles.card} ${styles.commentsCard}`}>
            <div className={styles.cardIcon}>💬</div>
            <div className={styles.cardContent}>
              <h2>التعليقات</h2>
          ...
          <Link href="/admin/stats" className={`${styles.card} ${styles.statsCard}`}>
            <div className={styles.cardIcon}>📊</div>
            <div className={styles.cardContent}>
              <h2>الإحصائيات</h2>
          ...
          <Link href="/admin/settings" className={`${styles.card} ${styles.settingsCard}`}>

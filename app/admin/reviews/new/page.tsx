    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.headerContent}>
          <Link href="/admin/reviews" className={styles.backBtn}>
            ← العودة
          </Link>
          <h1>مراجعة جديدة</h1>
        </div>
      ...
      <main className={styles.main}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          <div className={styles.section}>
            ...
            <div className={styles.field}>
              ...
              <textarea
                ...
                required
                rows={3}
                placeholder="ملخص قصير عن المراجعة"
              />
            </div>
            ...
            <div className={styles.field}>
              ...
              <textarea
                ...
                required
                rows={15}
                placeholder="محتوى المراجعة الكامل (HTML مسموح)"
          ...
          <div className={styles.actions}>
            ...
            <Link href="/admin/reviews" className={styles.cancelBtn}>
              إلغاء
            </Link>
          </div>
        </form>
